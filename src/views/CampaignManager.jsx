            ...
            {templates.length === 0 ? (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 16 }}>
                {templates.map(t => {
                  ...
                  const triggerLabel = { fitting_date: "Fitting Date", manual: "Manual", warranty_expiry: "Warranty Expiry", tns: "Treatment Not Started", tnl: "Tested No Loss" }[t.trigger_type] || t.trigger_type;
                  return (
